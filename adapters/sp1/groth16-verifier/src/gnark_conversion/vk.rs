...
use crate::{
    ...
    gnark_conversion::{g1::compressed_bytes_to_affine_g1, g2::compressed_bytes_to_affine_g2},
};
...
pub(crate) fn load_vk_from_gnark_bytes(buffer: &[u8]) -> Result<Groth16VerifyingKey, Groth16Error> {
...
mod tests {
    ...
    #[test]
    fn test_vk_serde() {
        let vk = load_vk_from_gnark_bytes(&GROTH16_VK_BYTES).unwrap();
