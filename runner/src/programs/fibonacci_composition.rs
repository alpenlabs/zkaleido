...
use zkaleido::{AggregationInput, PerfReport, ZkVmHost, ZkVmProver};
...
#[cfg(feature = "sp1")]
pub fn sp1_fib_composition_report() -> PerfReport {
...
#[cfg(feature = "risc0")]
pub fn risc0_fib_composition_report() -> PerfReport {
